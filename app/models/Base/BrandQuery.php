 ...
 *
 * @method     ChildBrandQuery leftJoinClothesBrand($relationAlias = null) Adds a LEFT JOIN clause to the query using the ClothesBrand relation
 * @method     ChildBrandQuery rightJoinClothesBrand($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ClothesBrand relation
 * @method     ChildBrandQuery innerJoinClothesBrand($relationAlias = null) Adds a INNER JOIN clause to the query using the ClothesBrand relation
 *
...
abstract class BrandQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\BrandQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Brand', $modelAlias = null)
    {
    ...
    public function filterByClothesBrand($clothesBrand, $comparison = null)
    {
        if ($clothesBrand instanceof \ClothesBrand) {
            return $this
                ->addUsingAlias(BrandTableMap::COL_ID, $clothesBrand->getBrandId(), $comparison);
